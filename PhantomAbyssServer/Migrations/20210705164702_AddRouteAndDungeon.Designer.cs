...
namespace PhantomAbyssServer.Migrations
{
    ...
    [Migration("20210705164702_AddRouteAndDungeon")]
    partial class AddRouteAndDungeon
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PhantomAbyssServer.Database.Models.Route", b =>
                {
                    ...
                    b.Property<string>("WageredWhipId")
                        .IsRequired()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("PhantomAbyssServer.Database.Models.SavedRun", b =>
                {
                    b.HasOne("PhantomAbyssServer.Database.Models.Dungeon", null)
                        .WithMany("SavedRuns")
